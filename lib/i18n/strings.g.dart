...
class _StringsRu implements _StringsEn {
  ...
  // Translations
  @override
  late final _StringsCommonwordsRu commonwords = _StringsCommonwordsRu._(_root);
  @override
  late final _StringsErrorsRu errors = _StringsErrorsRu._(_root);
  @override
  late final _StringsHomepageRu homepage = _StringsHomepageRu._(_root);
  @override
  late final _StringsTaskpageRu taskpage = _StringsTaskpageRu._(_root);
}
...
class _StringsCommonwordsRu implements _StringsCommonwordsEn {
  ...
  // Translations
  @override
  String get confirmation => 'Вы уверены?';
  @override
...
class _StringsErrorsRu implements _StringsErrorsEn {
  ...
  // Translations
  @override
  String get iternal => 'Внутренняя ошибка сервера';
  @override
  String get no_internet => 'Отсутствует подключение к интернету';
  @override
  String get unknown => 'Неопознанная ошибка';
}
...
class _StringsTaskpageRu implements _StringsTaskpageEn {
  ...
  @override
  String get until => 'Срок выполнения';
  @override
  String get until_short => 'До';
  @override
...
extension on _StringsEn {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'commonwords.confirmation':
        return 'Are you sure?';
      case 'commonwords.confirm':
        return 'Confirm';
      case 'commonwords.cancel':
        return 'Cancel';
      case 'commonwords.retry':
        return 'Retry';
      case 'errors.iternal':
      ...
      case 'homepage.mytasks':
        return 'My tasks';
      case 'homepage.done':
        return 'Is done';
      case 'homepage.newtask':
        return 'New task';
      case 'taskpage.task':
        return 'Task';
      case 'taskpage.name':
        return 'Task name';
      case 'taskpage.description':
        return 'Description';
      case 'taskpage.save':
        return 'Save';
      case 'taskpage.until':
        return 'Due date';
      case 'taskpage.until_short':
        return 'Until';
      case 'taskpage.priority':
        return 'Priority';
      case 'taskpage.low':
        return 'Low';
      case 'taskpage.regular':
        return 'Regular';
      case 'taskpage.hight':
        return 'Hight';
      case 'taskpage.critical':
        return 'Critical';
